...
<body>
    ...
    <div class="search-wrapper">
        <label for="search" >Beverages, wine, alcohol Search:</label>
        <input type="search" id="search" data-search  placeholder="enter a beverage item" oninput="searchItems()">
    </div>
    ...
    <!-- pop up window -->
    <button onclick="openPopup()" class="open-button" id= "open-window-btn">Open List of Beverages, wine, alcohol Items</button>
    ...
    <div id="popup" class="popup">
        <div class="popup-content">
            ...
            <h3>Beverages, wine, alcohol List:</h3>
                   
            <div class="search-wrapper-window">
                <label for="search">Beverages, wine, alcohol Search:</label>
                <input type="search" id="search-window" data-search  placeholder="enter a beverage item" oninput="searchItemsWindow()">
            </div>
            
      
            <ul class="items-container-window">
               
                <li class="selectable-window" id="arak-window" onclick="selectItem('arak-window')">
                <img src="Beverages, wine, alcohol/arak.png" alt="arak">
                <p>Arak</p>
                </li>

                <li class="selectable-window" id="fuzetea-window" onclick="selectItem('fuzetea-window')">
                <img src="Beverages, wine, alcohol/fuzetea.jpg" alt="fuzetea">
                <p>fuzetea</p>
                </li>

                <li class="selectable-window" id="Grapefruit juice-window" onclick="selectItem('Grapefruit juice-window')">
                <img src="Beverages, wine, alcohol/Grapefruit juice.png" alt="Grapefruit_juice">
                <p>Grapefruit juice</p>
                </li>


                <li class="selectable-window" id="Orange juice-window" onclick="selectItem('Orange juice-window')">
                <img src="Beverages, wine, alcohol/Orange juice.png" alt="Orange juice">
                <p>Orange juice</p>
                </li>

                <li class="selectable-window" id="red wine-window" onclick="selectItem('red wine-window')">
                <img src="Beverages, wine, alcohol/red wine.jpg" alt="red wine">
                <p>red wine</p>
                </li>

                <li class="selectable-window" id="soda-window" onclick="selectItem('soda-window')">
                <img src="Beverages, wine, alcohol/soda.jpg" alt="soda">
                <p>soda</p>
                </li>

                <li class="selectable-window" id="Tirosh-window" onclick="selectItem('Tirosh-window')">
                <img src="Beverages, wine, alcohol/Tirosh.png" alt="Tirosh">
                <p>Tirosh</p>
                </li>

                <li class="selectable-window" id="Vodka-window" onclick="selectItem('Vodka-window')">
                <img src="Beverages, wine, alcohol/Vodka.jpg" alt="Vodka">
                <p>Vodka</p>
                </li>

                <li class="selectable-window" id="water-window" onclick="selectItem('water-window')">
                <img src="Beverages, wine, alcohol/water.jpg" alt="water">
                <p>water</p>
                </li>

                <li class="selectable-window" id="whiskey-window" onclick="selectItem('whiskey-window')">
                <img src="Beverages, wine, alcohol/whiskey.jpg" alt="whiskey">
                <p>whiskey</p>
                </li>

                <li class="selectable-window" id="white wine-window" onclick="selectItem('white wine-window')">
                <img src="Beverages, wine, alcohol/white wine.jpg" alt="white wine">
                <p>white wine</p>
                </li>
...
window.addEventListener('scroll', () => {
    ...
    // Assuming you have a list of beverage IDs
    var beverageIds = ['arak', 'fuzetea', 'Grapefruit juice', 'Orange juice', 'red wine', 'soda', 'Tirosh', "Vodka", 'water', 'whiskey', 'white wine'];
...
function openPopupMinQuantity(beverageName) {
    var popupElement = document.getElementById("beverage-popup" + beverageName);
    var buttonElement = document.getElementById('topLeftButton' + beverageName);

    if (popupElement && buttonElement) {
        popupElement.classList.add('beverage-popup');

        popupElement.style.display = "block";
        buttonElement.style.display = 'none';
    } else {
        console.error("Popup or button element not found for", beverageName);
    }
}

function openPopupAddToCart(beverageName) {
    var popupElement = document.getElementById("beverage-popup-addToCart" + beverageName);
    var buttonElement = document.getElementById('topLeftButton-AddToCart' + beverageName);

    if (popupElement && buttonElement) {
        popupElement.classList.add('beverage-popup-addToCart');
...
function closePopupMinQuantity(beverageName) {
    var popupElement = document.getElementById("beverage-popup" + beverageName);
    var buttonElement = document.getElementById('topLeftButton' + beverageName);

    if (popupElement && buttonElement) {
        // Remove the specific class when closing the popup
        popupElement.classList.remove('beverage-popup');
...
function closePopupAddToCart(beverageName) {
    var popupElement = document.getElementById("beverage-popup-addToCart" + beverageName);
    var buttonElement = document.getElementById('topLeftButton-AddToCart' + beverageName);

    if (popupElement && buttonElement) {
        popupElement.classList.remove('beverage-popup-addToCart');
...
function addItemToMainContainer() {
    ...
    if (selectedItems.length > 0) {
        ...
        selectedItems.forEach(function(selectedItem) {
            // Get the beverage name (assuming it's in the alt attribute of the image)
            var beverageName = selectedItem.querySelector('img').alt;

            // Check if the item with the same name already exists in the main container
            var existingItem = document.getElementById("main-" + beverageName);
            ...
            if (!existingItem) {
                ...
                <button onclick="openPopupMinQuantity('${beverageName}')" class="top-left-button with-icon" id="topLeftButton${beverageName}">define minimum quantity </button>
                    <div id="beverage-popup${beverageName}" class="popup"> 
                        <div class="popup-content-beverages">
                            <span class="close" onclick="closePopupMinQuantity('${beverageName}')">&times;</span>
                            <h6> Minimum Quantity: </h6>
                            <p class="input-row">
                                <input type="number" id="beverage-quantity${beverageName}" class="beverage-quantity" min="0" step="1" value="0" style="width: 60px; height:25px;">
                                <select id="beverage-unit${beverageName}" class="beverage-unit-select" style="width: 60px; height:25px;">
                                    <option value="units">units</option>
                                    <option value="kg">kg</option>
                                    <option value="gram">gram</option>
                                </select>
                            </p>
                            <button class="setBtn" onclick="closePopupMinQuantity('${beverageName}')" id="set${beverageName}" style="width: 60px; height:25px;"> set</button>
                        </div>
                    </div>

                    </br>
                    <button onclick="openPopupAddToCart('${beverageName}')" class="top-left-button" id="topLeftButton-AddToCart${beverageName}" >Add To Cart</button>
                    <div id="beverage-popup-addToCart${beverageName}" class="popup"> 
                        <div class="popup-content-beverages">
                            <span class="close" onclick="closePopupAddToCart('${beverageName}')">&times;</span>
                            <h6>Add To Cart: </h6>
                            <p class="input-row">
                                <input type="number" id="beverage-quantity-addToCart${beverageName}" class="beverage-quantity-addToCart" min="0" step="1" value="0" style="width: 60px; height:25px;">
                                <select id="beverage-unit-addToCart${beverageName}" class="beverage-unit-select-addToCart" style="width: 60px; height:25px;">
                                    <option value="units">units</option>
                                    <option value="kg">kg</option>
                                    <option value="gram">gram</option>
                                </select>
                            </p>
                            <button class="setBtn" onclick="closePopupAddToCart('${beverageName}')" id="set-addToCart${beverageName}" style="width: 60px; height:25px;"> set</button>
                        </div>
                    </div>
                <div>
                    ...
                    <div class="item-details">
                        <p>Unit:
                            <select id="unit${beverageName}" class="unit-select">
                                <option value="units">units</option>
                                <option value="kg">kg</option>
                                <option value="gram">gram</option>
                            </select>
                        ...
                        <div class="quantity-container" id="quantityContainer${beverageName}">
                        <button class="decrement">
                            <i class="fas fa-minus"></i> 
                        </button>
                        <input type="number" id="quantity${beverageName}" class="quantity-input small-space" min="0" step="1" value="0" style="padding: 5px;">
                        <button class="increment">
                            <i class="fas fa-plus"></i> 
                        </button>
                        </div>

                        <div id="stickyNote${beverageName}" class="sticky-note">
                            <textarea id="noteText${beverageName}" class="note-text" placeholder="Write your note here..."></textarea>
                            <input id="Date${beverageName}" class="item-date" type="date">
                            <button id="saveNoteButton${beverageName}" class="save-button">Save</button>
                        </div> 
                    </div>
                    <div class="favorite">
                        <i id="starIcon${beverageName}" class="far fa-star"></i> 
                    </div>
                `;

                // Update the ID to make it unique
                var newItemId = "main-" + beverageName;
                ...
                // Make an AJAX request to addBeverage.php to add default information to the item in the database
                var xhr = new XMLHttpRequest();
                console.log ( "from addItemToMainContainer");
                xhr.open("POST", "addBeverage.php", true);
                ...
                xhr.send(`beverageName=${beverageName}&account_id=${account_id}`);
               ...
               var saveNoteButton = newItem.querySelector('#saveNoteButton' + beverageName);
                saveNoteButton.addEventListener('click', function () {
                    var quantity = newItem.querySelector('#quantity' + beverageName).value;
                    var note = newItem.querySelector('#noteText' + beverageName).value;
                    var item_date = newItem.querySelector('#Date' + beverageName).value;
                    var unit = newItem.querySelector('#unit' + beverageName).value;

                });

                } else {
                    // Alert or notify the user that the item already exists in the main container
                    alert("Item '" + beverageName + "' is already in the main container.");
                }
            });
...
function handleItemChange(event) {
    ...
    if (item) {
        ...
        const beverageId = item.id.replace('main-', '');
        ...
        const starIcon = document.querySelector('[id^="starIcon' + beverageId + '"]');
        ...
        const beverage_quantity = item.querySelector('.beverage-quantity').value;
        const beverage_unit_select = item.querySelector('.beverage-unit-select').value;

        const beverage_quantity_addToCart = item.querySelector('.beverage-quantity-addToCart').value;
        const beverage_unit_select_addToCart = item.querySelector('.beverage-unit-select-addToCart').value;

        // Use AJAX or another method to send the data to addBeverage.php
        ...
        const data = `beverageName=${beverageId}&beverage_quantity=${beverage_quantity}&beverage_unit_select=${beverage_unit_select}&account_id=${account_id}&quantity=${quantity}&note=${note}&unit=${unit}&isStarred=${isStarred}&is_selected=${isSelected}&date=${date}&beverage_quantity_addToCart=${beverage_quantity_addToCart}&beverage_unit_select_addToCart=${beverage_unit_select_addToCart}`;
        xhr.send(data);

        // Log the changes to the console
        console.log(`Item changed: ${beverageId}, Quantity: ${quantity}, Starred: ${isStarred}, Selected: ${isSelected}, Date: ${date}`);

        const quantityContainer = document.getElementById(`quantityContainer${beverageId}`);
        /*
        console.log(beverageId);
        if (beverage_quantity > quantity ){
            console.log("error");
            document.getElementById(`quantityContainer${beverageId}`).classList.add('warning');
        } else {
            document.getElementById(`quantityContainer${beverageId}`).classList.remove('warning');
        }
        */


        // Get the unit of the minimum quantity from the database
        const minQuantityUnit = item.querySelector('.beverage-unit-select').value;


       
        if (parseFloat(beverage_quantity) > parseFloat(quantity) && minQuantityUnit===unit) {
...
function addItem() {
    ...
    // Encode data and send the request
    const data = `&beverageName=${beverageName}&beverage_quantity=${beverage_quantity}&beverage_unit_select=${beverage_unit_select}&account_id=${account_id}&date=${date}&quantity=${quantity}&note=${note}&unit=${unit}&isStarred=${isStarred}&is_selected=${isSelected}`;
    xhr.send(data);
}
...
function fetchStarredItems() {
    ...
    xhrFetchStarredItems.open("POST", "fetchStarredItemsBeverages.php", true);
...
function addItemToMainContainerStar(beverageId) {
    console.log(beverageId);
    beverageName = beverageId.beverage_id;
    const account_id = <?php echo json_encode($account_id); ?>;
    ...
    if (!existingItem) {
        ...
        newItem.innerHTML = `
                ...
                <div>
                    ...
                    <div class="favorite">
                        <i id="starIcon${beverageName}" class="fas fa-star"></i> 
                    </div>
                `;
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                console.log(xhr.responseText); // Log the response from the server
                var jsonResponse = JSON.parse(xhr.responseText);
                // here I get the previous data from the beverages database !!! 
                var jsonResponse = JSON.parse(xhr.responseText);
                ...
                var curMinQuantity= jsonResponse.existingMinQuantity;
                var MinQuantityInput = document.getElementById('beverage-quantity' + curFruit);
                MinQuantityInput.value = curMinQuantity;

                var curUnitMinQuantity = jsonResponse.existingUnitMinQuantity;
                var UnitMinQuantityInput = document.getElementById('beverage-unit' + curFruit);
                UnitMinQuantityInput.value = curUnitMinQuantity;

                var curAddToCart = jsonResponse.existingAddToCart;
                var AddToCartInput = document.getElementById('beverage-quantity-addToCart' + curFruit);
                AddToCartInput.value = curAddToCart;

                var curUnitAddToCart = jsonResponse.existingUnitAddToCart;
                var UnitAddToCartInput = document.getElementById('beverage-unit-addToCart' + curFruit);
                UnitAddToCartInput.value = curUnitAddToCart;
...
var minQuantityInput = document.getElementById('beverage-quantity' + beverageName);
var quantityContainer = document.getElementById('quantityContainer' + beverageName);
